...
class test_add_contact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, GroupContact(firstname="Stas", lastname="Emelianov", title="Mr", email="emelianov.stanislav@gmail.com"))
        self.logout(wd)
    ...
    def test_add_empty_contact(self):
        ...
        self.login(wd, username="admin", password="secret")
        self.open_new_contact_page(wd)
        self.create_contact(wd, GroupContact(firstname="", lastname="", title="", email=""))
        self.logout(wd)
